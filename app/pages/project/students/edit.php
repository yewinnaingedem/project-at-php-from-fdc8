...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        ...
                        if($from == 'list'){
                            ...
                            $data = $app->selectRecord($query);                                                                            
                            $_SESSION['old-values']['name'] = $data['name'];
                            $_SESSION['old-values']['gender'] = $data['gender'];
                            $_SESSION['old-values']['age'] = $data['age'];
                            $_SESSION['old-values']['address'] = $data['address'];
                            $_SESSION['old-values']['id_number'] = $data['id_number'];
                            $_SESSION['old-values']['grade'] = $data['grade'];
                            $_SESSION['old-values']['parent_name'] = $data['parent_name'];
                            $_SESSION['old-values']['contact_address'] = $data['contact_address'];
                            $_SESSION['old-values']['contact_phone'] = $data['contact_phone'];
                        }
                    ...
                    <form action="../../../controllers/student/edit.php" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="contact_address" class="form-control" rows="4"><?php echo isset( $_SESSION['old-values']['contact_address'])?  $_SESSION['old-values']['contact_address']: '';  ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Contact Phone (Optional)</label>
                            <input type="text" class="form-control" name="contact_phone" value="<?php echo isset( $_SESSION['old-values']['contact_phone'])?  $_SESSION['old-values']['contact_phone']: '';  ?>">
                        </div>
                        <div class="mb-3">
    ...
    <script>
        $(document).ready(()=>{
            let gender = "<?php echo isset( $_SESSION['old-values']['gender'])?  $_SESSION['old-values']['gender']: '';  ?>";
            if(gender){
                $('[name="gender"]').val(gender);     
            }

            let grade = "<?php echo isset( $_SESSION['old-values']['grade'])?  $_SESSION['old-values']['grade']: '';  ?>";            
            if(grade){
