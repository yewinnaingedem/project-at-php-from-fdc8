            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ajax Example 1</h1>                      
                    </div>  
                    
                    
                    <button class="btn btn-primary" id="load-alerts">Load Alerts</button>
        ...
        $(document).ready(()=>{
            $('#load-alerts').click(()=>{
                ...
                $.ajax({
                    type: "get",
                    dataType: "text",
                    url:"./ajax-example-2-data-prepare-script.php",
                    success: (data)=>{   
                        console.log(data);
