...
<head>
    ...
    <title>file open and write</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1>Write the file</h1>
                    <?php 
                        $file = fopen('./write-file.txt','a') or die('Unable to write file');
                        fwrite($file,"Myat Thu Aung\n");
                        fwrite($file,"StrongForce Technology\n");
                        fclose($file);
                    ?>

                    <h1>Read the file</h1>
                    <?php
                        $file = fopen('./write-file.txt','r') or die('Unable to open file.');
                        while(!feof($file)){
                            echo fgets($file) . "</br>";                            
                        }
                        fclose($file);
