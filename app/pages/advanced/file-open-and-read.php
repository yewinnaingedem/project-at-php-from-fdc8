        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                        $file = fopen('./read-file.txt','r') or die('Unable to open file.');
                        echo fread($file,filesize('./read-file.txt'));
                        fclose($file);
                    ?>
                    <hr>
                    <h1>Read the file line by line.</h1>
                    <?php
                        $file = fopen('./read-file.txt','r') or die('Unable to open file.');
                        while(!feof($file)){
                            echo fgets($file) . "</br>";                            
                    ...
                    <h1>Read the file character by character.</h1>
                    <?php
                        $file = fopen('./read-file.txt','r') or die('Unable to open file.');
                        while(!feof($file)){
                            echo fgetc($file) . "---";                            
