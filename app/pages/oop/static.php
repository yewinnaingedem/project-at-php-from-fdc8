            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Static</h1>                      
                    </div>

                    <h3>Static Methods & Properties</h3>
                    <ul>
                        <li>
                            Object မဆောက်ပဲ class ကနေ method တွေ variables တွေကို တိုက်ရိုက်ခေါ်သုံးချင်လျှင် static ကို အသုံးပြုနိုင်သည်။
                        </li>                
                    </ul>
                    <hr>
                    ...
                    <?php
                        class Math{
                            ...
                            public static function round($num){
                                echo "change {$num} to round.</br>";
                            }

                            public static function ceil($num){
                                echo "change {$num} to ceil.</br>";
                            }
                        }
